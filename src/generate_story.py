...
def _generate_prompt(characters, persona, ending=""):
    ...
    등장인물들의 페르소나를 설정한 후 드라마 플롯을 만들어줘. 레전드 설정은 막장 드라마 요소를 포함한, 20대 독자들이 매우 흥미가질만한 상상하기 어렵고 창의적인 설정이야. 각 인물의 말투는 성격을 잘 보여주어야 해. 엔딩이 나오기까지 어느정도의 서사가 있어야하며, 레전드 설정이 일부 드러나야해. 선생님이라면 담당 과목, 회사라면 사업 내용과 같이 모든 요소는 구체적으로 기술되어야 해. 등장인물 간의 궁합을 0부터 100 사이의 값으로 알려줘. 그리고 궁합 설명을 '둘이 없어 죽고 못 사는 사이 ♥️'와 같이 한 마디로 문장으로 말해줘. 아래의 json 형식 이외에 미사여구를 붙이지마.
