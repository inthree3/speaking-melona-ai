...
def _generate_prompt(characters, persona, ending=""):
    ...
    json_format
    {{
    "상황": 대화가 진행되는 시간, 장소, 분위기에 대한 한 줄 나레이션,
    "엔딩": 20대 독자들이 강렬하고 자극적으로 느낄 만한 엔딩,
    "캐릭터": [
        {{
        "이름": "캐릭터 이름",
        "페르소나": 캐릭터별 제공된 페르소나,
        "레전드_설정": 캐릭터별 자극적인 설정 (ex - ㅇㅇㅇ은 천재적인 범죄자이며, ㅇㅇㅇ의 동생을 포함한 여러 사건의 배후. 겉으로는 연약해 보이지만, 사실 머리 좋은 전략가로서 많은 사람들이 그의 존재를 두려워한다 or ㅇㅇ은 삼각 관계에 끼어들어, ㅇㅇ과 ㅇㅇ을 서로 빼앗기 위해 모든 것을 할 수 있다. ㅇㅇ은 겉으로는 양아치인 척을 하지만, 그건 자신을 이렇게 만든 세상에 대한 반항일 뿐, 사실은 누구보다 순수한 마음을 가지고 있다.)
    }}
    ],
    "플롯": [
            {{
